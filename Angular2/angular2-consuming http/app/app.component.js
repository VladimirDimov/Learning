            ...
            AppComponent = (function () {
                ...
                AppComponent.prototype.getPeople = function () {
                    ...
                    this.appService.getPeople()
                        .subscribe(function (data) { return _this.people = data; }, function (err) { return console.log(err); });
                };
                AppComponent.prototype.addPerson = function (name) {
                    var _this = this;
                    this.appService.addPerson(name)
                        .subscribe(function (res) { return _this.post = res; }, function (err) { return console.log(err); }, function () { return console.log("Done!"); });
                };
